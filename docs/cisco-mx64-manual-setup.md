...
- Cihazınızda herhangi bir sorun olursa daha önce alınan boot yedeği: `backups/orig_mtd0_boot_<timestamp>.bin`
- USB üzerinden kurtarma adımları için [Cisco Meraki MX64 Kurtarma Kılavuzu](cisco-mx64-recovery-guide.md) dosyasını referans alabilirsiniz.
