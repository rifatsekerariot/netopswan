...
export const metadata: Metadata = {
  ...
  title: {
    default: 'NetOpsWan - SD-WAN & Şube Yönetim Konsolu',
    template: '%s | NetOpsWan SD-WAN'
  },
  description:
    'Cisco Meraki MX64 OpenWrt Filo Yönetimi, Şube Ağ Politikaları, IPAM ve Güvenlik Sertifika Yönetim Konsolu.',
  openGraph: {
